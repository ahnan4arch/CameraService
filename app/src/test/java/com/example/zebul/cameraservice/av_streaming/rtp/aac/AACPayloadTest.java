...
public class AACPayloadTest {
    ...
    */
    ...
    public static byte [] SAMPLE_VLC_AAC_HEADER_DATA = new byte[]{(byte)0x00 ,(byte)0x10 ,(byte)0x0C ,(byte)0x60};
    public static byte [] SAMPLE_VLC_ACCESS_UNIT_DATA = new byte[]{
    ...
    static byte [] SAMPLE_VLC_PAYLOAD = null;
    static{
        SAMPLE_VLC_PAYLOAD = new byte[SAMPLE_VLC_AAC_HEADER_DATA.length+SAMPLE_VLC_ACCESS_UNIT_DATA.length];
        System.arraycopy(SAMPLE_VLC_AAC_HEADER_DATA, 0, SAMPLE_VLC_PAYLOAD, 0, SAMPLE_VLC_AAC_HEADER_DATA.length);
        System.arraycopy(SAMPLE_VLC_ACCESS_UNIT_DATA, 0, SAMPLE_VLC_PAYLOAD, SAMPLE_VLC_AAC_HEADER_DATA.length, SAMPLE_VLC_ACCESS_UNIT_DATA.length);
    }


    @Test
    public void compare_serialization_with_vlc__sample1() throws Exception {

        AccessUnit accessUnit = new AccessUnit(SAMPLE_VLC_ACCESS_UNIT_DATA);
        ...
        assertArrayEquals(SAMPLE_VLC_PAYLOAD, outputPayload);
    }
}
