...
public class H264Depacketizer {
        ...
        switch(h264Payload.getH264PayloadType()){
            ...
            case FU_A:
                ...
                if(fuHeader.isEnd()){
                    ...
                    if(hasContinousSequenceNumbers(fuRTPPackets) && timestampInEveryPacketIsEqual(fuRTPPackets)){
    ...
    private boolean timestampInEveryPacketIsEqual(List<RTPPacket> fuRTPPackets) {
        return true;
    }
