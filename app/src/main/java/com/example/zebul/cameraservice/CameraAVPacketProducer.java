...
public class CameraAVPacketProducer implements AVPacketProducer {

    private static final String TAG = "CameraAVPacketProducer";
            ...
            if (outputBufferIndex >= 0)
            {
                ...
                if (mBufferInfo.size != 0)
                {
                    ...
                    try{
                        ...
                        buffer.get(data, mBufferInfo.offset, data.length);
    ...
    public AVPackets produceAVPackets() throws AVPacketProductionException {
        ...
        synchronized (this) {
            ...
            if (VERBOSE) Log.d(TAG, "avPackets contains "+result.getNumberOfPackets()+" packets");
            return result;
        }
    }
