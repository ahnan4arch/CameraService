...
public class CameraVideoH264PacketProducer implements H264PacketProducer {
    ...
    private H264Packets h264Packets = new H264Packets();
    ...
    private void drainEncoder1(boolean endOfStream) {
            ...
            if (outputBufferIndex >= 0)
            {
                ...
                if (mBufferInfo.size != 0)
                {
                    ...
                    try{
                        ...
                        outputBuffer.get(data, mBufferInfo.offset, data.length);
                        //return mBufferInfo.presentationTimeUs;

                        NALUnit nalUnit = new NALUnit(0, data);
                        //long timestampInMillis = mBufferInfo.presentationTimeUs/1000;
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    try{
                        ...
                        byte [] data = new byte[mBufferInfo.size];
                        encodedData.get(data, mBufferInfo.offset, data.length);
                        //return mBufferInfo.presentationTimeUs;
    ...
    public H264Packets produceH264Packets() throws PacketProductionException {
        ...
        synchronized (this) {
            ...
            H264Packets result = h264Packets;
            h264Packets = new H264Packets();
            if (VERBOSE) Log.d(TAG, "h264Packets contains "+result.getNumberOfPackets()+" packets");
            return result;
        }
    }
    ...
    private static final long DURATION_SEC = 20;             // 8 seconds of video
    ...
    private void prepareEncoder(int width, int height, int bitRate) throws IOException {
        ...
        */
        ...
        mInputSurface = new CodecInputSurface(mediaCodec.createInputSurface());
        mediaCodec.start();
