...
import com.example.zebul.cameraservice.utils.MiscUtils;
...
public class PlayMovieActivity extends Activity implements OnItemSelectedListener,
    ...
    private static final String TAG = PlayMovieActivity.TAG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final File filesDir = getMovieDir();
        mMovieFiles = MiscUtils.getFiles(filesDir, "*.mp4");
        ...
        if (mShowStopLabel) {
            ...
            try {
                player = new MoviePlayer(
                        new File(getMovieDir(), mMovieFiles[mSelectedMovie]), surface, callback);
