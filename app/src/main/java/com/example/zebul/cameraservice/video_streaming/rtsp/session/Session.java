...
public class Session {
	...
	*/
	...
	public String getDescription(){
		...
		descriptionBuilder.append(m_formatMediaDescriptions()	+RTSPProtocol.LINE_SEPARATOR);
		
		descriptionBuilder.append("a=rtpmap:96 H264/90000"+RTSPProtocol.LINE_SEPARATOR);
		//descriptionBuilder.append("a=fmtp:96 packetization-mode=1;profile-level-id=42801f;sprop-parameter-sets=Z0KAH+kCg/I=,aM4G8g==;"+RTSPProtocol.LINE_SEPARATOR);
	...
	private String m_formatMediaDescriptions() {
		/*
   ...
   <fmt> is a media format description.  The fourth and any subsequent
      ...
      m=<media> <port> <proto> <fmt> ...
		*/
		...
		String mediaDescriptions = String.format("m=%s %d %s %d", media, destinationPort, proto, mediaFormatDescription);
