...
import com.example.zebul.cameraservice.av_streaming.rtp.payload.RTPPayload;
import com.example.zebul.cameraservice.av_streaming.rtp.payload.RTPPayloadType;
import com.example.zebul.cameraservice.av_streaming.rtp.payload.fragmentation_unit.FUHeader;
import com.example.zebul.cameraservice.av_streaming.rtp.payload.fragmentation_unit.FUIndicator;
import com.example.zebul.cameraservice.av_streaming.rtp.payload.fragmentation_unit.FU_A_RTPPayload;
import com.example.zebul.cameraservice.av_streaming.rtp.payload.single_time.STAP_A_RTPPayload;
    ...
    class RTPPacketizer{
        ...
        private List<RTPPacket> makeFragmentationUnitPackets(AVPacket avPacket) {
            ...
            while(true){
                ...
                byte nalUnitType = (byte)nalUnitHeader.getNalUnitType().ordinal();
